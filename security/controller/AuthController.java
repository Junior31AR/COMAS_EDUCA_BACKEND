...
public class AuthController {
	...
	public ResponseEntity<?> actualizarUsuario(@Valid @RequestBody Usuario usuario, BindingResult result,
		...
		if (usuarioActual == null) {
			response.put("mensaje", "Error: No se pudo editar el usuario con el ID: "
	...
	public ResponseEntity<?> nuevo(@Valid @RequestBody NuevoUsuario nuevoUsuario, BindingResult result) {
		...
		Usuario usuario = new Usuario(nuevoUsuario.getUsername(), passwordEnconder.encode(nuevoUsuario.getPassword()),
				nuevoUsuario.getEnabled());
