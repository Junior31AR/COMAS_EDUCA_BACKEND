...
public class CursoController {
	...
	public ResponseEntity<?> getCurso(@PathVariable Long id) {
		...
		if (curso.isEmpty()) {
			response.put("mensaje",
					"El curso con el ID: ".concat(id.toString().concat(" no existe en la base de datos")));
	...
	@PreAuthorize("hasRole('ADMIN')")
	@PutMapping("/{id}")
	public ResponseEntity<?> updateCurso(@Valid @RequestBody Curso curso, BindingResult results,
		...
		if (cursoActual == null) {
			response.put("mensaje", "Error: No se pudo editar, el curso con el ID: "
	...
	public ResponseEntity<?> deleteCurso(@PathVariable Long id) {
		...
		if (curso == null) {
			response.put("mensaje", "Error: No se pudo eliminar, el curso con el ID: "
					.concat(id.toString().concat(" no existe en la base de datos")));
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.NOT_FOUND);
		}
