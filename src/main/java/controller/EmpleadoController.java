...
public class EmpleadoController {
	...
	public ResponseEntity<?> getEmpleado(@PathVariable Long id) {
		...
		if (empleado.isEmpty()) {
			response.put("mensaje",
					"El Empleado con el ID: ".concat(id.toString().concat(" no existe en la base de datos")));
	...
	@PreAuthorize("hasRole('ADMIN')")
	@PutMapping("/{id}")
	public ResponseEntity<?> updateEmpleado(@Valid @RequestBody Empleado empleado, BindingResult results,
		...
		if (empleadoActual == null) {
			response.put("mensaje", "Error: No se pudo editar, el empleado con el ID: "
	...
	public ResponseEntity<?> deleteEmpleado(@PathVariable Long id) {
		...
		if (empleado == null) {
			response.put("mensaje", "Error: No se pudo eliminar, el empleado con el ID: "
					.concat(id.toString().concat(" no existe en la base de datos")));
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.NOT_FOUND);
		}
