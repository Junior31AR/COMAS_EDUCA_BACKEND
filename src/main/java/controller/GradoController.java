...
public class GradoController {
	...
	public ResponseEntity<?> getGrado(@PathVariable Long id) {
		...
		if (grado.isEmpty()) {
			response.put("mensaje",
					"El grado con el ID: ".concat(id.toString().concat(" no existe en la base de datos")));
	...
	@PreAuthorize("hasRole('ADMIN')")
	@PutMapping("/{id}")
	public ResponseEntity<?> updateGrado(@Valid @RequestBody Grado grado, BindingResult results,
		...
		if (gradoActual == null) {
			response.put("mensaje", "Error: No se pudo editar, el grado con el ID: "
	...
	public ResponseEntity<?> deleteGrado(@PathVariable Long id) {
		...
		if (grado == null) {
			response.put("mensaje", "Error: No se pudo eliminar el grado con el ID: "
					.concat(id.toString().concat(" no existe en la base de datos")));
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.NOT_FOUND);
		}
