...
public class MatriculaController {
	...
	@GetMapping("/notas")
	public ResponseEntity<List<Nota>> getNotas(@RequestParam("idCurso") String idCurso,
			@RequestParam("idAula") String idAula) {
		return new ResponseEntity<>(notaDao.notasPorAulaYCurso(Long.parseLong(idCurso), Long.parseLong(idAula)),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<?> getReporteCursoXLS(@RequestParam("idCurso") String idCurso,
	...
	public ResponseEntity<?> obtenerAsistenciasPorDia(@RequestParam("fecha") String fecha,
			@RequestParam("idAula") String idAula) {
		return new ResponseEntity<>(asistenciaService.findAsistenciaByFechaAula(fecha, Long.parseLong(idAula)),
				HttpStatus.OK);
	}

	@PreAuthorize("hasRole('ADMIN')")
	@GetMapping("/getCursoReporte")
	public ResponseEntity<List<CursoReporte>> getCursoReporte(@RequestParam("idCurso") String idCurso,
			@RequestParam("idGrado") String idGrado) {
		List<CursoReporte> cursoReporteList = claseService.getCursoReporte(Long.parseLong(idCurso),
	...
	public ResponseEntity<List<Matricula>> getMatriculasPorEstudiante(@Param("id") String id) {
		return new ResponseEntity<List<Matricula>>(matriculaService.getMatriculasPorEstudiante(Long.parseLong(id)),
				HttpStatus.OK);
	}
